    ...
    <>
      ...
      <div className="bg-terracotta text-cream py-3 px-4 text-center text-sm">
        <span className="font-light">
          Upcoming: Summer Solstice Sound Bath - June 21st
        </span>
        <Link
          to="/events"
      ...
      <section className="min-h-[85vh] grid grid-cols-1 lg:grid-cols-2">
        <div className="flex flex-col justify-center px-6 lg:px-16 xl:px-24 pt-16 lg:pt-8 pb-16">
          ...
          <p className="animate-fade-up-3 text-base leading-relaxed text-charcoal max-w-lg mb-4 font-light">
            A community-rooted healing project guiding you into deeper
            connection with your body, land, and spirit through plant medicine,
            movement, sound, and culturally-rooted practices.
          </p>
          <p className="animate-fade-up-3 text-base leading-relaxed text-charcoal max-w-lg mb-10 font-light">
            Where healing becomes a pathway to liberation - individual and
            collective.
          </p>
        ...
        <div className="hidden lg:flex relative bg-gradient-to-br from-clay via-terracotta to-ochre items-center justify-center overflow-hidden">
          <span className="text-cream/50 text-lg font-display italic">
            [ Hero Image ]
          </span>
        </div>
      </section>
      ...
      <Section bg="warm-sand">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-normal text-deep-earth mb-8 leading-relaxed">
            My offerings weave together Mesoamerican healing traditions, yoga,
            chakra balancing, sound healing, herbalism, and holistic nutrition.
          </h2>
          <p className="text-base leading-relaxed text-charcoal font-light max-w-2xl mx-auto">
            Supporting people in releasing what no longer serves them and
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative w-full aspect-video bg-deep-earth/5 overflow-hidden shadow-xl">
            <iframe
              ...
              src="https://www.youtube.com/embed/fLMd3_gRXBg"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {offerings.map((offering) => (
            ...
            >
              ...
              <h3 className="font-display text-xl text-deep-earth mb-3">
                {offering.title}
              </h3>
              <p className="text-sm leading-relaxed text-charcoal font-light mb-4">
      ...
      <Section bg="warm-sand" padding="lg">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between mb-12">
          <div>
            ...
            <h2 className="font-display text-4xl md:text-5xl font-normal text-deep-earth">
              Upcoming Events
            </h2>
          </div>
          <Link
            to="/events"
            className="mt-6 lg:mt-0 text-sm tracking-wider uppercase text-terracotta hover:text-deep-earth transition-colors"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {upcomingEvents.map((event) => (
            <div
              key={event.title}
              className="bg-cream p-6 border border-clay/20"
            >
              <p className="text-xs tracking-wider uppercase text-sage mb-3">
                {event.date}
              </p>
              <h3 className="font-display text-xl text-deep-earth mb-2">
                {event.title}
              </h3>
              <p className="text-sm text-charcoal font-light mb-4">
                {event.description}
              </p>
              <Link
                to="/events"
